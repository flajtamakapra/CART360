...
ofxMaxim: a library using c++ maximillian for openFramworks
https://guthub.com/micknoise/maxim
...
class ofApp : public ofBaseApp{
	...
	public:
        ...
        double currentFrame, currentFrameBass, currentVolume, modulationIndex, modulationFrequency;
        double outputs[2], bassputs[2], modSpeed;
